    ...
    public class NBC2025Plugin
    {
        ...
        public void Run(cSapModel SapModel)
        {
            ...
            try
            {
                ...
                double[][] spec = BuildSpectrum(Z, I, Rmu, OmegaU, Tc, Td, alpha, k);
                double[] Tv = spec[0];
                double[] Sv = spec[1];
        ...
        {
            double[] Tv = new double[29];
            Tv[0]=0.0;  Tv[1]=0.05; Tv[2]=0.10; Tv[3]=0.15; Tv[4]=0.20;
            Tv[5]=0.25; Tv[6]=0.30; Tv[7]=0.40; Tv[8]=0.50; Tv[9]=0.60;
            Tv[10]=0.70;Tv[11]=0.80;Tv[12]=0.90;Tv[13]=1.00;Tv[14]=1.20;
            Tv[15]=1.40;Tv[16]=1.60;Tv[17]=1.80;Tv[18]=2.00;Tv[19]=2.50;
            Tv[20]=3.00;Tv[21]=3.50;Tv[22]=4.00;Tv[23]=4.50;Tv[24]=Td;
            Tv[25]=Td+0.1;Tv[26]=6.0;Tv[27]=8.0;Tv[28]=10.0;

            double[] Sv = new double[29];
            for (int i=0;i<29;i++)
        ...
        void MakeRSFunc(string name, double[] T, double[] Sa, double damp)
        {
            try
            {
                int nPts = T.Length;
                _m.Func.FuncRS.SetFromList(name, nPts, ref T, ref Sa, damp);
            }
            catch
            {
                try
                {
                    int nPts = T.Length;
                    _m.Func.FuncRS.SetUser_1(name, nPts, ref T, ref Sa, damp);
                }
                catch {}
            }
        }
        ...
        void MakeRSCase(string name, string func, string dir, double sf, double ecc)
        {
            try
            {
                ...
                int      n    = 1;
                string[] dirs = new string[]{"U1"};
                dirs[0]       = dir;
                string[] fns  = new string[]{func};
                double[] sfs  = new double[]{sf};
                string[] cSys = new string[]{"Global"};
                double[] angs = new double[]{0.0};
                _m.LoadCases.ResponseSpectrum.SetLoads(
                    name, n, ref dirs, ref fns, ref sfs, ref cSys, ref angs);
        ...
        void LC(string name, string[] pats, double[] sfs)
        {
            try
            {
                _m.RespCombo.Add(name, eComboType.LinearAdd);
        ...
        void EC(string name, string[] subs)
        {
            try
            {
                _m.RespCombo.Add(name, eComboType.Envelope);
                eCNameType cType = eCNameType.Combo;
